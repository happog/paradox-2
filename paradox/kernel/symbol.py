...
class Symbol:
    ...
    def get_value(self, variables=None):
        return pd.Engine(self, variables).value()

    def get_gradient(self, variables=None):
        return pd.Engine(self, variables).gradient(variables).get_value()
